...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
    header("location: ../../learning-project");
    exit;
}
?>
          ...
          <a class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <div class="media align-items-center">
              <span class="avatar avatar-sm rounded-circle">
                <img alt="Image placeholder" src="../assets/images/theme/team-1-800x800.jpg">
              </span>
            </div>
          </a>
...
<!--===============================================================================================-->
        ...
        <?php echo htmlspecialchars($_SESSION["firstname"]); ?> <?php echo htmlspecialchars($_SESSION["lastname"]); ?>
            ...
            <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
              ...
              <div class="dropdown-divider"></div>
              <a href="../logout/auth" class="dropdown-item">
                <i class="ni ni-user-run"></i>
                <span>Logout</span>
              </a>
            </div>
  ...
  <!-- Argon Scripts -->
  <!-- Core -->
  <script src="../assets/vendor-in-one/jquery/dist/jquery.min.js"></script>
