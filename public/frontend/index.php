...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="assets/land.io/css/landio.min.css">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div id="collapsingNavbar" class="collapse navbar-toggleable-custom">
          <ul class="nav navbar-nav navbar-nav-transparent float-right">
            ...
            <li class="nav-item nav-item-toggable">
              <a class="nav-link" href="register/" target="_blank" rel="nofollow">Register</a>
            </li>
    ...
    <header class="jumbotron bg-dark d-md-flex flex-md-column justify-content-md-center align-items-md-center" role="banner">
      ...
      <div class="text-center">
        ...
        <br>
        <a class="btn btn-outline-light btn-lg btn-outline-light mb-4 mb-md-0" href="register/" role="button"><span class="icon-email"></span>Try Now</a>
      </div>
    ...
    <section class="section-intro bg-light text-center">
      <div class="container">
        ...
        <img src="assets/images/mock.png" alt="iPad mock" class="img-fluid wp wp-3">
      </div>
    </section>
          ...
          <div class="col-md-4">
            <div class="card mb-0">
              <div class="card-body">
                ...
                <p class="card-text">We build systems using the PHP programming language and not use the PHP Framework. <b><h6><i>Since this is a beta stage, we may use the PHP Framework in the going forward</i></h5></b>.</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <script src="assets/land.io/js/landio.min.js"></script>
  </body>
</html>
